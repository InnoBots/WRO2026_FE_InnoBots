...
The original version was used to test steering, sensor placement, and autonomous navigation concepts. After extensive testing, the team redesigned several mechanical components using SolidWorks and manufactured custom 3D-printed parts to improve performance, reliability, and modularity.
